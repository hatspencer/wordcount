...
public class TestData {
	...
	public static final String THREE_WORDS_WITH_DESIGNATED_STOPWORD = "he the idea";
	public static final String FOUR_WORDS_WITH_SAME_STOPWORDs = " he the  the  idea ";
	public static final String FOUR_WORDS_WITH_DESIGNATED_STOPWORDs = " he the  has  a ";
