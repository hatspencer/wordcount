...
public class TestSentenceInformation extends AbstractWordTest {
    ...
    public void testSampleSentence() {
        ...
        Assert.assertEquals("The word count does not match", (Integer) 9,sentenceInformation.getWords());
        Assert.assertEquals("The unique count is not valid", (Integer) 7, sentenceInformation.getUnique());
    }

    @Test
    public void testUnique() {
        SentenceInformation sentenceInformation = getSentenceInformation("Humpty-Dumpty Humpty-Dumpty");
        Assert.assertEquals("The word count does not match", (Integer) 4,sentenceInformation.getWords());
